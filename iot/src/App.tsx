...
import { Thermometer, Activity, AlertTriangle, CheckCircle, MapPin, Loader2, Menu, LayoutDashboard, Cpu, Bell, Camera, Car, Database } from 'lucide-react';
...
import { useDetectionAlerts, DetectionAlert } from './hooks/useDetectionAlerts';
import { getDevices, generateHistoricalData, getDeviceStats, getDeviceById, Device, TemperatureDataPoint, DeviceStats } from './services/deviceService';
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 bg-white border-r border-slate-200">
        <div className="p-6 border-b border-slate-200">
          <div className="flex items-center gap-3">
            <img 
              src="https://play-lh.googleusercontent.com/m_3IvYMqDBZAlM_zOlZd4YZzGB8Mbe-ecnNWbVvH3yXFqUe28w0u9jE3KYNp6oZNsw" 
              alt="RaceTrac Logo"
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden lg:block">
                  <h1 className="text-slate-900">
                    ...
                    {activeView === 'detections' && 'Object Detection'}
